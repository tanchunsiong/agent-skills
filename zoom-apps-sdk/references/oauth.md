...
User clicks "Add" in Marketplace
    |
    v
GET https://zoom.us/zoom-oauth/authorize
...
app.get('/auth', async (req, res) => {
  ...
  const tokenResponse = await axios.post('https://zoom.us/zoom-oauth/token', null, {
    params: {
...
```
POST https://zoom.us/zoom-oauth/token
...
async function refreshTokens(refreshToken) {
  const response = await axios.post('https://zoom.us/zoom-oauth/token', null, {
    params: {
