...
- [zoom-team-chat skill](../../zoom-team-chat/skill.md)
- [zoom-rest-api skill](../../zoom-rest-api/SKILL.md)
- [oauth skill](../../zoom-oauth/SKILL.md)
- [Chatbot Setup Example](../../zoom-team-chat/examples/chatbot-setup.md)
- [LLM Integration Example](../../zoom-team-chat/examples/llm-integration.md)
- [Claude Chatbot Sample](https://github.com/zoom/zoom-chatbot-claude-sample)

## Next Steps

1. Build basic chatbot using [Chatbot Setup](../../zoom-team-chat/examples/chatbot-setup.md)
