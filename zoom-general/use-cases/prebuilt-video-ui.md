...
- **[zoom-ui-toolkit](../../zoom-ui-toolkit/SKILL.md)** - Complete UI Toolkit documentation
- **[zoom-video-sdk](../../zoom-video-sdk/web/SKILL.md)** - Raw Video SDK (when UI Toolkit isn't enough)
...
2. **Migrate to raw Video SDK**:
   ...
   - See [zoom-video-sdk](../../zoom-video-sdk/web/SKILL.md) for migration guide
...
- **Skill**: [zoom-ui-toolkit](../../zoom-ui-toolkit/SKILL.md)
- **Live Demo**: https://sdk.zoom.com/videosdk-uitoolkit
- **Official Docs**: https://developers.zoom.us/docs/zoom-video-sdk/web/zoom-ui-toolkit/
