...
| 2 | **zoom-webhooks** | Subscribe to and receive meeting events |
...
└─────────────────────────────────────────────────────────────────────────┘
                                    ...
                                    ▼
┌─────────────────────────────────────────────────────────────────────────┐
│ 3. Receive Meeting Events (zoom-webhooks)                               │
...
## Step 3: Handle Meeting Events (zoom-webhooks)
 ...
 * 2. zoom-webhooks - Real-time event updates
 */
...
app.listen(3000, () => {
  ...
  console.log('  POST /webhooks/zoom           - Webhook receiver (zoom-webhooks)');
});
```
