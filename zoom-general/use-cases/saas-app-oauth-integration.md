...
- App Type: OAuth
- Redirect URL: `https://yourapp.com/zoom-oauth/callback`
- Required scopes: `meeting:write`, `meeting:read`, `user:read`

**See:** `zoom-oauth/concepts/oauth-flows.md#user-authorization-oauth`
...
app.get('/connect-zoom', (req, res) => {
  ...
  res.redirect(
    `https://zoom.us/zoom-oauth/authorize?` +
    `response_type=code&` +
    `client_id=${CLIENT_ID}&` +
...
**See:** `zoom-oauth/examples/user-oauth-mysql.md`
...
**See:** `zoom-oauth/concepts/token-lifecycle.md#user-oauth--device-flow-token-lifecycle`
...
**See:** `zoom-oauth/examples/token-refresh.md`
...
**See:** `zoom-oauth/examples/user-oauth-mysql.md#token-encryption`
...
**See:** `zoom-oauth/concepts/state-parameter.md`
...
**See:** `zoom-oauth/troubleshooting/token-issues.md`
