...
2. Use `recording_token` in config (get from [Recording Token API](https://developers.zoom.us/docs/zoom-meeting-sdk/apis/#operation/meetingLocalRecordingJoinToken))
...
- **Official docs**: https://developers.zoom.us/docs/zoom-meeting-sdk/linux/
