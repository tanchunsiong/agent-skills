...
**Alternative:** See [zoom-rtms/examples/rtms-bot.md](../../zoom-rtms/examples/rtms-bot.md) for invisible, read-only access via RTMS.
...
- **Meeting SDK Linux**: https://developers.zoom.us/docs/zoom-meeting-sdk/linux/
- **Raw Data Guide**: https://developers.zoom.us/docs/zoom-meeting-sdk/linux/add-features/raw-data/
- **OBF FAQ**: https://developers.zoom.us/docs/zoom-meeting-sdk/obf-faq/
