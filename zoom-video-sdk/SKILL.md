...
name: zoom-video-sdk
description: |
  Zoom Video SDK for building custom video experiences (not Zoom meetings) on web, React Native, Flutter, and Linux platforms. 
...
- **[react-native/SKILL.md](react-native/SKILL.md)** - React Native Video SDK (mobile wrapper, helper/event architecture)
  - **[react-native/INDEX.md](react-native/INDEX.md)** - React Native documentation navigation
...
- **[flutter/SKILL.md](flutter/SKILL.md)** - Flutter Video SDK (mobile wrapper, event-driven architecture)
  - **[flutter/INDEX.md](flutter/INDEX.md)** - Flutter documentation navigation
...
- **Official docs**: https://developers.zoom.us/docs/zoom-video-sdk/
