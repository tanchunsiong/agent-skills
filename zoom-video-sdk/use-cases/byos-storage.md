...
Use the [Video SDK BYOS Storage APIs](https://developers.zoom.us/docs/api/zoom-video-sdk/#tag/byos-storage):
...
Use the [Cloud Recording APIs](https://developers.zoom.us/docs/api/zoom-video-sdk/#tag/cloud-recording) to manage, play, and download BYOS recordings.
...
- **BYOS Storage APIs:** https://developers.zoom.us/docs/api/zoom-video-sdk/#tag/byos-storage
- **Cloud Recording APIs:** https://developers.zoom.us/docs/api/zoom-video-sdk/#tag/cloud-recording
