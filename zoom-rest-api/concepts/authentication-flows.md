...
2. Redirect to: https://zoom.us/zoom-oauth/authorize?response_type=code&client_id=XXX&redirect_uri=YYY&state=ZZZ
...
- **S2S OAuth**: https://developers.zoom.us/docs/internal-apps/s2s-zoom-oauth/
