...
```
https://zoom.us/zoom-oauth/authorize?response_type=code&client_id={clientId}&redirect_uri={redirectUri}&state={state}
```
...
- **OAuth Guide**: https://developers.zoom.us/docs/integrations/zoom-oauth/
- **Server-to-Server OAuth**: https://developers.zoom.us/docs/internal-apps/s2s-zoom-oauth/
